...
class ZabbixHandler:
    ...
    def check_instances(self):
        ...
        token_timeleft=self.keystone_auth.checkTokenLifetime(self.token_expires)
        if token_timeleft < 300: #less than five minutes
            full_token=keystone_auth.getTokenV2()
            self.token=full_token['id']
            self.token_expires=full_token['expires']
            print "token has been renewed"
            print full_token['expires']
    ...
    def check_instances(self):
        ...
        self.check_token_lifetime(self.token_expires,3500)
